...
import com.example.weather.DB.MyDB;
import com.example.weather.util.DateFormatType;
import com.example.weather.util.MyFormat;
import com.example.weather.util.MyTimeGetter;

import java.util.Calendar;
import java.util.Date;

import static com.example.weather.util.MyFormat.getTimeStr;
import static com.example.weather.util.MyFormat.myDateFormat;
